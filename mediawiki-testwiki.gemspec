# -*- encoding: utf-8 -*-
# stub: mediawiki-testwiki 0.0.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.licenses = ["AGPL-3.0"]
  s.post_install_message = "\nmediawiki-testwiki-0.0.2 [2014-09-29]:\n\n* Fixed <tt>setup:config</tt> task.\n* fixed <tt>nginx.conf</tt> file.\n* Fixed gem dependencies.\n* Updated README.\n\n"
  s.rdoc_options = ["--title", "mediawiki-testwiki Application documentation (v0.0.2)", "--charset", "UTF-8", "--line-numbers", "--all", "--main", "README"]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<docker_helper>, [">= 0.0.2", "~> 0.0"])
      s.add_development_dependency(%q<mechanize>, ["~> 2.7"])
      s.add_development_dependency(%q<hen>, [">= 0"])
      s.add_development_dependency(%q<rake>, [">= 0"])
    else
      s.add_dependency(%q<docker_helper>, [">= 0.0.2", "~> 0.0"])
